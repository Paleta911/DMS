...
describe('UsersAreasPage', () => {
  ...
  it('muestra una guía inicial antes de seleccionar un usuario', () => {
    ...
    expect(
      screen.getByText('Busca un correo o nombre y elige un usuario para revisar su cuenta, sus registros y sus áreas actuales.'),
    ).toBeInTheDocument();
  });
  ...
  it('recupera filtros guardados por usuario en usuarios y áreas', async () => {
    ...
    expect(screen.getByTestId('user-search-value')).toHaveTextContent('sus@bsm.com.mx');
