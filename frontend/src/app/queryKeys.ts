export const queryKeys = {
  ...
  permissions: {
    ...
    adminList: (params: unknown) => ['admin-permission-requests', params] as const,
    adminDetail: (requestId: number | string) => ['admin-permission-request', requestId] as const,
  },
  registrations: {
  ...
  adminCatalogs: {
    ...
    documentTypes: (params: unknown) => ['admin-document-types', params] as const,
